...
public:
    ...
    // --- Configuração de DNS ---
    void setDNS(const IPAddress& primaryDNS, const IPAddress& secondaryDNS = INADDR_NONE);
    ...
    String m_defaultApName = "ESP Irrigação";
    String m_defaultApPassword = "12345678";       // vazia = portal aberto

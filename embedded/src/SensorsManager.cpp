/*
The purpose os this class is to manage the sensors of the system. It will read
the sensors and update the system state accordingly.
*/
...
uint8_t SensorsManager::getSoilMoisture() {
